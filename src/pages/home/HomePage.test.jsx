...
import { MemoryRouter } from "react-router";  //MemoryRouter is specifically for testing
...
describe("HomePage Components", () => {
  ...
  it('adds a product to the cart', async () => {
    ...
    const addToCartButton1 = within(productContainers[0]).getByTestId('add-to-cart');
    ...
    const addToCartButton2 = within(productContainers[1]).getByTestId('add-to-cart');
